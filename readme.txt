...
Before first submission, replace the Contributors placeholder with the exact WordPress.org username. Keep Tested up to aligned with the WordPress version exercised by CI and real compatibility testing.
